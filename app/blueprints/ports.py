...
def lancer_scan(target, port_range=1024):
    ports_ouverts = []
    ...
    return {'ports': ports_ouverts, 'total': len(ports_ouverts), 'target': target, 'range': port_range}
    ...
    if request.method == 'POST':
        ...
        if not ip:
            ...
            try:
                ...
                erreur = f"Erreur : {e}"
    return render_template('scanner.html', active='ports', resultats=resultats, erreur=erreur)
